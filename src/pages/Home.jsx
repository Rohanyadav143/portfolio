      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <h1 className="text-5xl mt-8 sm:text-6xl lg:text-7xl font-extrabold
            ...
            <h3 className="mt-3 text-2xl sm:text-3xl font-semibold">
              I'm{" "}
              <span className="bg-gradient-to-r from-yellow-400 to-pink-500
            ...
            {/* SOCIAL */}
            <div className="flex gap-8 mt-5 text-3xl text-gray-300
            justify-center lg:justify-start">
              <a href="https://github.com/Rohanyadav143" target="_blank" className="hover:text-green-400 transition">
                <FaGithub />
              </a>
              <a href="https://www.linkedin.com/in/rohan-yadav-20b064255" target="_blank" className="hover:text-green-400 transition">
                <FaLinkedin />
              </a>
              <a href="https://leetcode.com/rohn1895" target="_blank" className="hover:text-green-400 transition">
                <FaLink />
              </a>
            </div>
